class profiles::uitpas::api::cron (
  ...
  cron { 'uitpas balie financial reminderemail':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/balie/financial-reminderemail' >> ${cron_logdir}/balie-financial-reminderemail.log 2>&1",
    hour    => '8',
    minute  => '0',
    monthday => '1',
    *       => $cron_default_attributes,
  ...
  cron { 'uitpas balie financial export cleanup':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/balie/financial-export-cleanup' >> ${cron_logdir}/balie-financial-export-cleanup.log 2>&1",
    hour    => '1',
    minute  => '14',
    *       => $cron_default_attributes,
  }
  ...
  cron { 'uitpas balie checkcardstockunderlimit':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/balie/checkcardstockunderlimit' >> ${cron_logdir}/balie-checkcardstockunderlimit.log 2>&1",
    hour    => '0',
    minute  => '15',
    *       => $cron_default_attributes,
  }
  ...
  cron { 'uitpas orders check incomplete orders':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/orders/check-incomplete-orders' >> ${cron_logdir}/orders-check-incomplete-orders.log 2>&1",
    hour    => '9',
    minute  => '0',
    *       => $cron_default_attributes,
  }
  ...
  cron { 'uitpas passholder kansenstatuutalmostexpired':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/passholder/kansenstatuutalmostexpired' >> ${cron_logdir}/passholder-kansenstatuutalmostexpired.log 2>&1",
    hour    => '0',
    minute  => '45',
    *       => $cron_default_attributes,
  }
  ...
  cron { 'uitpas passholder norecentcheckinreminder':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/passholder/norecentcheckinreminder' >> ${cron_logdir}/passholder-norecentcheckinreminder.log 2>&1",
    hour    => '0',
    minute  => '25',
    *       => $cron_default_attributes,
  }
  ...
  cron { 'uitpas passholder welcomemailreminder':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/passholder/welcomemailreminder' >> ${cron_logdir}/passholder-welcomemailreminder.log 2>&1",
    hour    => '0',
    minute  => '10',
    *       => $cron_default_attributes,
  }
  ...
  cron { 'uitpas periodic cardsystemmembership cleaning':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/periodic-cardsystemmembership-cleaning' >> ${cron_logdir}/periodic-cardsystemmembership-cleaning.log 2>&1",
    hour    => '3',
    minute  => '38',
    *       => $cron_default_attributes,
  }
  ...
  cron { 'uitpas external ticketsales sync':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/external-ticketsales/sync' >> ${cron_logdir}/external-ticketsales-sync.log 2>&1",
    hour    => '4',
    minute  => '45',
    *       => $cron_default_attributes,
  }
  ...
  cron { 'uitpas external ticketsales resolve':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/external-ticketsales/resolve' >> ${cron_logdir}/external-ticketsales-resolve.log 2>&1",
    hour    => '5',
    minute  => '1',
    *       => $cron_default_attributes,
  }
  ...
  cron { 'uitpas external ticketsales process':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/external-ticketsales/process' >> ${cron_logdir}/external-ticketsales-process.log 2>&1",
    hour    => '5',
    minute  => '45',
    *       => $cron_default_attributes,
  }
  ...
  cron { 'uitpas external ticketsales alert':
    ...
    command => "/usr/bin/curl '${base_url}/uitid/rest/cron/external-ticketsales/alert' >> ${cron_logdir}/external-ticketsales-alert.log 2>&1",
    hour    => '6',
    minute  => '45',
    *       => $cron_default_attributes,
  }
