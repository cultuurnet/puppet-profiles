...
$dependencies = ['xvfb', 'libnss3', 'libxrandr2', 'libgbm1', 'libxkbcommon0',
                 'libxdamage1', 'libxcomposite1', 'libxfixes3', 'libcairo2',
                 'libpango-1.0-0']

$arch_dependencies = $facts['os']['release']['major'] ? {
                      '20.04' => ['libatspi2.0-0', 'libcups2', 'libatk-bridge2.0-0', 'libasound2'],
                      default => ['libatspi2.0-0t64', 'libcups2t64', 'libatk-bridge2.0-0t64', 'libasound2t64'],
}
