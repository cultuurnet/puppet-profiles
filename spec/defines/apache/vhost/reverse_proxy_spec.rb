...
describe 'profiles::apache::vhost::reverse_proxy' do
  ...
  context "with title => https://michelangelo.example.com" do
    ...
    context "with certificate => 'foobar.example.com', destination => https://buonarotti.example.com/, preserve_host => true, allow_encoded_slashes => nodecode, proxy_keywords => ['interpolate', 'noquery'] and aliases => ['mich.example.com', 'angelo.example.com']" do
      let(:params) { {
