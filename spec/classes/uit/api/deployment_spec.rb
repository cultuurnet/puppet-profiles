describe 'profiles::uit::api::deployment' do
  ...
  context "with config_source => appconfig/uit/api/env, maximum_heap_size => 1024, service_port => 3456, version => 1.2.3, repository => uit-api-exotic, service_status => stopped, newrelic_license_key => ping, newrelic_app_name => pong and puppetdb_url => http://example.com:8000" do
    let(:params) { {
      'config_source'        => 'appconfig/uit/api/env',
      'version'              => '1.2.3',
