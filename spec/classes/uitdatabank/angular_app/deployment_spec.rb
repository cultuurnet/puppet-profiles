describe 'profiles::uitdatabank::angular_app::deployment' do
  ...
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      context 'with config_source => appconfig/uitdatabank/udb3-angular-app/config.json' do
        let(:params) { {
          'config_source' => 'appconfig/uitdatabank/udb3-angular-app/config.json'
        } }
      ...
      context 'with config_source => appconfig/uitdatabank/udb3-angular-app/myconfig.json, version => 4.5.6, repository => myrepo and puppetdb_url => http://puppetdb.example.com' do
        let(:params) { {
          'config_source' => 'appconfig/uitdatabank/udb3-angular-app/myconfig.json',
          'version'       => '4.5.6',
          'repository'    => 'myrepo',
