describe 'profiles::uitdatabank::jwt_provider_uitidv1' do
    ...
    context "on #{os}" do
      ...
      context 'with servername => baz.example.com' do
        ...
        context 'with hieradata' do
          ...
          it { is_expected.to contain_class('profiles::uitdatabank::jwt_provider_uitidv1').with(
            'servername'    => 'baz.example.com',
            'serveraliases' => [],
            'deployment'    => true
          ) }
          ...
          it { is_expected.to contain_class('profiles::uitdatabank::jwt_provider_uitidv1::deployment') }

          it { is_expected.to contain_class('profiles::uitdatabank::jwt_provider_uitidv1::deployment').that_subscribes_to('Class[profiles::php]') }
        end
      ...
      context 'with servername => jwt.example.com' do
        ...
        it { is_expected.not_to contain_class('profiles::uitdatabank::jwt_provider_uitidv1::deployment') }
      end
