  ...
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      context "on host aaa.example.com" do
        ...
        context "with version => 1.2.3, dns_alt_names => puppet.services.example.com, initial_heap_size => 512m, maximum_heap_size => 512m, service_enable => false and service_ensure => stopped" do
          let(:params) { {
            'version'           => '1.2.3',
      ...
      context "on host bbb.example.com" do
        ...
        context "with dns_alt_names => [ puppet1.services.example.com, puppet2.services.example.com]" do
          let(:params) { {
